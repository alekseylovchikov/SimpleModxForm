 ...
 * Update an Item
 */
class SimpleModxFormItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('simplemodxform_item_err_ns');
		}
...
return 'SimpleModxFormItemUpdateProcessor';
