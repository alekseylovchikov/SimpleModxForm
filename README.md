...
SimpleModxForm is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/SimpleModxForm.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory SimpleModxForm is now in, and do this:
...
Now, you'll want to change references to SimpleModxForm in the files in your
new copied-from-SimpleModxForm repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'SimpleModxForm' to whatever the
name of your component is.

## Copyright Information

SimpleModxForm is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of SimpleModxForm the ability to modify, distribute
and use SimpleModxForm in MODx development as they see fit, as long as attribution
